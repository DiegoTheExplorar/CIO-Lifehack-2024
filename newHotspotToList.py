...
patrol_locations = pd.read_csv('bob_with_swapped_coordinates.csv')
...
with open('district_patrols2.csv', 'w', newline='') as file:
...
print("Completed writing to district_patrols2.csv")
